...
while fivesige1<0:
    strength+=1
    v=getcorrelation('20220104-FRB180814.J422+73-T1.csv',25,450,550,1/1200,strength=strength, histogram=False)
    r=v[0]
    error=v[1][1]
    fivesige1=r-5*error
print('end of first estimation')
strength=strength-1
fivesige2=-1
while fivesige2<0:
    strength+=0.25
    ...
    error=v[1][1]
    fivesige2=r-5*error
print('end of second estimation')
...
while fivesige4<0:
    ...
    fivesige4=r-5*error
    print(fivesige4)
print('end of forth estimation')
v = getcorrelation('20220104-FRB180814.J422+73-T1.csv', 25, 450, 550, 1 / 1200, strength=strength, histogram=True)
plt.savefig('Distribution of Correlation Coefficients at Strength:'+str(strength)+'.png')
print(strength,r)
plt.figure()
plt.plot(strength,r,'.')
plt.errorbar(strength,r, capsize=10, yerr=error, fmt='none')
...
with open('Results.txt', 'a') as f:
    f.writelines('\n\n'+'Number of Rs per Gaussian Fit: '+str(25)+', Critical Strength: '+str(strength)+', Critical R: '+str(r))
f.close()

plt.savefig('Strength of Correlation at Critical 5S Strength ('+str(strength)+').png')
plt.show()
print(strength)
print(fivesige4)
